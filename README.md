...
<ul>
  ...
  <li>Change the following parameters in the following functions.
    ...
    <p>get_auth_code($client_id, $redirect_uri, $auth_code, $appID_secret_base64) -> change $client_id to your App ID, and $appID_secret_base64 to the base64 encoded value of (YourAppID:AppSecret)</p></li>
